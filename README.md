...
### Honeypot Logging Disclaimer

In a real production environment, honeypots are usually isolated and **not** ingested into the same SIEM pipelines as enterprise endpoints.  
For this lab, the honeypot is intentionally integrated into Elastic for practice:
...
This setup is for **training and educational purposes only**, not a recommended production architecture.
